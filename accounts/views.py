...
from accounts.models import User, Transaction, Wallet
...
class OwnerListViewset(viewsets.ModelViewSet):
...
class WalletViewset(OwnerListViewset):
...
class TransactionViewset(OwnerListViewset):
